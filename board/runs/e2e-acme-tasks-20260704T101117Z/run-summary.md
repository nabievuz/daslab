---
run_id: e2e-acme-tasks-20260704T101117Z
pack: acme-tasks
...
# Run summary — e2e-acme-tasks-20260704T101117Z
...
- [x] run workspace created and delivered board staged as the LOCAL artifact (e2e-acme-tasks-20260704T101117Z/workspace/delivered-board — scratch, gitignored)
...
```json
{
  ...
  "d5_health_check": {
    ...
    "workspace_path": "board/runs/e2e-acme-tasks-20260704T101117Z/workspace",
    "local_artifact": "board/runs/e2e-acme-tasks-20260704T101117Z/workspace/delivered-board",
    "probe": {
      "command": [
        "python3",
        "scripts/gateway_compile.py",
        "acme-tasks(delivered)",
        "--gate-walk"
      ],
      "returncode": 0,
      "exit_ok": true,
    ...
    "checklist": [
      ...
      {
        "ok": true,
        "label": "run workspace created and delivered board staged as the LOCAL artifact (e2e-acme-tasks-20260704T101117Z/workspace/delivered-board \u2014 scratch, gitignored)"
      },
      {
        "ok": true,
