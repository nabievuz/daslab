# Design — Runtime Instructions (DasLab)

> **Precedence level 5** (see [`../AGENTS.md`](../AGENTS.md) §2). This file is the
> runtime protocol for Design agents; the dept charter ([`CLAUDE.md`](CLAUDE.md))
...
- **Never review your own work.** When ready, set `status: in_review` and assign
  your reviewer per [`../board/ROUTING.md`](../board/ROUTING.md) (Design manager: CDO).
...
- Design artifacts (tokens, Figma sources in `mockups/`, research notes) live under
  `design/` per the charter — reference them by relative path.

## 4 — Skills available

Domain skills (design-system authoring, accessibility review, user research) are
