...
description: >
  ...
  (§5.5/§6). Drives post-deploy health checks through the Dokploy MCP (ADR 0001).
---
...
green. Primary instrument: the **Dokploy MCP** (`mcp__dokploy__*`, ADR 0001) — you already have it.
